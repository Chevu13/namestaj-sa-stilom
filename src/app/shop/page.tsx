      ...
      <section className="bg-cream-100 py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[10px] tracking-[4px] uppercase text-cream-500 mb-4">Ekskluzivna usluga</p>
              <h2 style={{fontFamily:'Cormorant Garamond,Georgia,serif'}} className="text-4xl md:text-5xl font-light text-charcoal-900 mb-5 leading-tight">
                Nameštaj rađen<br /><em className="italic text-cream-500">po vašoj meri</em>
              </h2>
              <p className="text-charcoal-600 text-sm leading-relaxed mb-4">
                Svaki prostor je jedinstven — zato nudimo izradu nameštaja po meri. Izaberite dimenzije, materijal, boju i stil koji savršeno odgovaraju vašem domu.
              </p>
              <p className="text-charcoal-600 text-sm leading-relaxed mb-8">
                Radimo ugaone garniture, krevete, klupe i ostali nameštaj prema vašim specifikacijama. Kontaktirajte nas i zajedno osmislimo vaš idealni komad.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <a
                  href="https://wa.me/381628599179?text=Zdravo%21%20Zanima%20me%20nameštaj%20po%20meri."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-charcoal-900 text-cream-100 px-7 py-3.5 text-sm font-medium hover:bg-charcoal-700 transition-colors"
                >
                ...
                <a
                  href="tel:+381628599179"
                  className="inline-flex items-center gap-2 border border-charcoal-900 text-charcoal-900 px-7 py-3.5 text-sm font-medium hover:bg-charcoal-900 hover:text-cream-100 transition-colors"
                >
                  <Phone size={15} />
                  Pozovite nas
                </a>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -right-5 bg-charcoal-900 px-6 py-4">
                <p style={{fontFamily:'Cormorant Garamond,Georgia,serif'}} className="text-3xl font-light text-cream-100">10+</p>
                <p className="text-[10px] tracking-[2px] uppercase text-cream-500">godina iskustva</p>
              </div>
            </div>
          </div>
        </div>
